...
def test_index(client, db_session, inbound_delivery_1):
    ...
    assert response_body == {'paging': {'page': 1,
            'pagination': {'next_page_url': 'http://localhost:8080/api/report/purchase-invoices?page=2',
                           'prev_page_url': None},
            'total_item': 2},
    'report_body': [[{'text': purchase_invoice.purchase_invoice_no},
                  {'text': purchase_invoice.invoice_date.strftime('%Y-%m-%d')},
                  ...
                  {'text': '2.000000'},
                  {'text': '0.000000'},
                  {'text': '3000.000000000000'},
                  {'text': inbound_delivery_1.inbound_delivery_date.strftime('%Y-%m-%d')},
                  {'text': inbound_delivery_1.inbound_delivery_no}],
                 [{'text': purchase_invoice.purchase_invoice_no},
                  {'text': purchase_invoice.invoice_date.strftime('%Y-%m-%d')},
                  {'text': 'CPU Noctua Fan'},
                  {'text': 'FAN'},
                  {'text': '3.000000'},
