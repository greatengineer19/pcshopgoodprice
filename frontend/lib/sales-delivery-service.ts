...
export const voidSalesDelivery = async (id: number): Promise<any> => {  
    try {
        ...
        const response = await fetch(
            "http://localhost:80/api/sales-deliveries/" + id  + "/void",
            {
                method: 'PATCH',
                headers: {
...
export const fullyDelivered = async (id: number): Promise<any> => {  
    try {
        ...
        const response = await fetch(
            "http://localhost:80/api/sales-deliveries/" + id  + "/fully_delivered",
            {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
...
export const fetchSalesDeliveries = async (): Promise<SalesDelivery[]> => {
    ...
    const response = await fetch('http://localhost:80/api/sales-deliveries', {
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
        }
