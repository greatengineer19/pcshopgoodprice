# TODO: This class should support api to 3rd party such as Xendit to process dummy bank transfer
...
import re
from .constants import bbb_bank_transfer
from fastapi.encoders import jsonable_encoder

router = APIRouter(
    prefix='/api/sales-payment/bank-transfer'
)
    ...
    try:
        ...
        payment_method = (
            db.query(PaymentMethod.id)
              .filter(PaymentMethod.name == bbb_bank_transfer).first()
        )
